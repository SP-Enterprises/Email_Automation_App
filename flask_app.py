...
from email_utils import (
    render_template_text, send_email, extract_docx_with_images,
    extract_text_from_docx, extract_text_from_pdf, html_to_plain_text
)
from datetime import datetime
import pandas as pd
import os, csv, re
...
def setup_routes(app, db, login_manager, mail):
    @login_manager.user_loader
    def load_user(user_id):
        with db.session() as session:
            return session.get(User, int(user_id))
